...
function my_keydown(e)
{
    ...
    console.log(keyPressed);
        ...
        if(keyPressed == '39')
        {
            ...
            if(keyPressed == '87') { up(); console.log("key w"); 
        } if(keyPressed == '83') { down(); console.log("key s"); 
    } if(keyPressed == '65') { left(); console.log("key a");
 } if(keyPressed == '68') { right(); console.log("key d"); }
}
